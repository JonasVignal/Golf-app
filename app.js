...
const COURSES = {
  ...
  ormehoj_norreskov: {
    ...
    smorum_intermediate: {
      ...
      tees: {
        t38: {
          label: "⚫ 38", length: 3808, rating: 60.7, slope: 97,
          lengths: [95, 231, 241, 233, 132, 435, 155, 106, 276, 95, 231, 241, 233, 132, 435, 155, 106, 276]
        },
        t32: {
          label: "🟡 32", length: 3226, rating: 57.7, slope: 90,
          lengths: [95, 195, 187, 198, 122, 345, 145, 100, 226, 95, 195, 187, 198, 122, 345, 145, 100, 226]
        }
      }
    },
